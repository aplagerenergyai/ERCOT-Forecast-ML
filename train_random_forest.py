...
Random Forest Regressor for DART spread prediction.
More robust to outliers and less prone to overfitting.
"""
...
def train_random_forest(X_train, y_train, X_val, y_val):
    ...
    logger.info("Note: Random Forest doesn't support early stopping")
...
def main():
    ...
    try:
        ...
        logger.info("="*80)
        output_path = "./outputs/random_forest_model.pkl"
